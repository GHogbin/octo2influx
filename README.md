...
- [`grafana/dashboard.json`](grafana/dashboard.json), an operational overview
  ...
  selectable 30-minute/hourly electricity usage cost and import, selected
  electricity/gas rates, converted gas kWh and tariff rate, selected tariff
  timeline, hour-of-day import, cumulative import, and ingestion health;
